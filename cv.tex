...
\ecvtitle[2.5mm]{February 2017 - Present}{Project Engineer}
\ecvitem{}{BeMicro LDA}
\ecvitem{}{Currently developing energy related products.
\par \textbullet\,\,Used to \textbf{weekly fast meetings} to update on progress, problems and plans.
\par \textbullet\,\,Embedded devices firmware development in \textbf{C} and \textbf{C++}.
\par \textbullet\,\,Backend development in \textbf{Javascript}.
\par \textbullet\,\,Mobile app development using \textbf{Javascript - React Native}.}

\ecvtitle[2.5mm]{April 2017 - January 2019}{Co-founder and CTO}
\ecvitem{}{SurgeonMate}
\ecvitem{}{Project started in the end of 2015, being full time in the pointed duration. This project aims to create a smartglasses device to record surgeries and a multimedia library software to catalog, store and stream those recordings in real time.
\par \textbullet\,\,Participation in \textbf{entrepreneurship bootcamps}.
\par \textbullet\,\,Backend development using \textbf{Javascript}.
\par \textbullet\,\,Web development using \textbf{Javascript}.
\par \textbullet\,\,Embedded devices firmware development in \textbf{Python}.
...
\ecvitem{}{\textbullet\,\,IT support and \textbf{Linux systems} and \textbf{networks admin}.
\par \textbullet\,\,Regular skills on building sites using \textbf{html}, \textbf{php} and \textbf{mysql}. 
\par \textbullet\,\,Regular skills on automating tasks using \textbf{Python}.
...
\par \textbullet\,\,Development of experimental setups and respective instrumentation and automation using dsPIC microcontrollers and integration of said experiments in the platform using \textbf{Java} and \textbf{XML}.
...
%\par\textbullet\,\,Regular skills using ORCAD 9.2 and EAGLE 6.5.0 for designing schematics and layouts of Printed Circuit Boards.
...
\ecvsection{Sports}
\ecvitem{1997 - 2012}{Karate}
\ecvitem{2019 - Pres}{Gym}
\ecvitem{2019 - Pres}{Airsoft}
